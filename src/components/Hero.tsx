...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 text-center pt-20">
        ...
        duration: 0.8,
        delay: 0.2
      }} className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight mb-8 text-card-foreground">
        ...
        duration: 0.8,
        delay: 0.4
      }} className="text-lg md:text-xl mb-10 max-w-3xl mx-auto text-secondary-foreground">
      ...
      duration: 0.6,
      delay: 0.8
    }} className="absolute bottom-8 left-0 bg-card/80 backdrop-blur-sm py-4 px-8">
        <div className="flex items-center gap-4 text-card-foreground text-sm">
